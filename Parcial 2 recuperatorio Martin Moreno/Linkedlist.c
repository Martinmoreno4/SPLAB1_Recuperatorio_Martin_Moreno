...
int ll_indexOf(LinkedList* this, void* pElement)
{
    ...
    if(this!=NULL)
    {
        ...
        for (int i=0;i<tam;i++)
        {
            if(ll_get(this,i)==pElement)//devuelve el p element a la posicion i
            {
                returnAux=i;
            }
        }
...
LinkedList* ll_subList(LinkedList* this,int from,int to)
{
    ...
    if(this!=NULL && from>=0 && from<to && to<=ll_len(this) && from<ll_len(this))
    {
...
/** \brief retorna una nueva lista que solo tenga los elementos deseados
 *
 * \param pList LinkedList* Puntero a la lista
 * \param pFunc (*pFunc) Puntero a la funcion criterio
 * \return
...
/** \brief itera los elementos de la lista, utilizando la funcion para asi cambiar sus datos
 *
 * \param *pFunc
